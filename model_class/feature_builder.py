...
class FeatureBuilder:
    def __init__(self):
        ...
        self.parent_table = None     # DataFrame indexed by (hostName, processId)


    def _stack_diversity(stack):
        '''
    ...
    def fit(self, df_train: pd.DataFrame):
        ...
        # parent lookup table learned from TRAIN only
        # self.parent_table = (
